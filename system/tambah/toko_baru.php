<form action="" method="get" enctype="multipart/form-data" >
	...
	<button type="submit" name="toko_baru" class="btn btn-primary">+Tambah</button>
	<button type="submit" name="tampil_kelola_toko" class="btn btn-primary">Kelola</button>		<br />	 <br />				
</form>
